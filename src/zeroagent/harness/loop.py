...
class AgentLoop:
    ...
    def _add_assistant_message(self, response) -> None:
        ...
        Pour OpenAI avec tool calls, le message assistant doit contenir
        les tool_calls pour que l'API accepte les messages tool suivants.
        Le contenu peut être None/vide si le LLM ne génère que des tool calls.
        """
